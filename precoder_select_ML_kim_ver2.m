function [F, F_idx]=precoder_select_ML_kim_ver2(H,nS)
...
plus_cond = [1:21 [22 23 24 29 30 31 32 36 37 38 39 43 44 45 46]];

% plus_cond = [22 23 24 29 30 31 32 36 37 38 39 43 44 45 46];
if nS == 4
        ...
        if stage_idx == nS
            ...
            if Is_New_Stage  
                ...
                if stage_idx==1    
                    ...
                    another_delta_x_cond(plus_cond) = false;
                end
