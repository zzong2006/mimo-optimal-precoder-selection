function [F, F_idx]=precoder_select_ML_kim_ver3(H,nS)
 ...
 %       if stage_idx == nS+1
        if stage_idx == nS
            ...
            if Is_New_Stage  
                ...
                if stage_idx == 1
                    squared_x_set = abs(delta_x_set_fs + coord).^2 ;
                else
                ...
                if stage_idx == 1
                    x_list(nS-stage_idx+1, 1:len_B)=delta_x_set_fs(another_delta_x_cond);
                else
